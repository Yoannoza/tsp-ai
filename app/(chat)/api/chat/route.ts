...
// Helper to convert UI messages to LangChain messages
function convertToLangChainMessages(messages: Array<any>): BaseMessage[] {
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Extraire le contenu du message pour le tracking
