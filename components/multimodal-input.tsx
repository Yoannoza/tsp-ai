...
function PureMultimodalInput({
  ...
  return (
    <div className={cn("relative flex w-full flex-col gap-2", className)}>
      ...
      <PromptInput
        className="rounded-xl border border-border bg-background p-1.5 shadow-xs transition-all duration-200 focus-within:border-border hover:border-muted-foreground/50"
        onSubmit={(event) => {
      ...
      >
        ...
        <div className="flex flex-row items-start gap-0.5 sm:gap-1">
          <PromptInputTextarea
            autoFocus
...
function PureAttachmentsButton({
  ...
  const isReasoningModel = selectedModelId === "chat-model";
