...
const suggestions = [
  {
    displayText: "Préparer mon ESN pour le B2G",
    shortText: "ESN & Marchés B2G",
    fullPrompt: "Explain the difference between the Held-Karp algorithm and the Nearest Neighbor heuristic. What are the time complexities?",
    icon: FileCheck,
    gradient: "from-primary to-primary/70",
  },
  {
    displayText: "Solve TSP with OR-Tools",
    shortText: "OR-Tools Solver",
    fullPrompt: "Write a Python script using OR-Tools to solve a TSP instance with 20 random cities.",
    icon: Users,
    gradient: "from-secondary to-secondary/70",
  },
  {
    displayText: "Explain Christofides",
    shortText: "Christofides Algo",
    fullPrompt: "What is the Christofides algorithm and when should I use it?",
    icon: DollarSign,
    gradient: "from-primary/80 to-secondary",
  },
  {
    displayText: "Visualize TSP Tour",
    shortText: "Visualization",
    fullPrompt: "How can I visualize a TSP tour using Matplotlib in Python?",
    icon: Mail,
